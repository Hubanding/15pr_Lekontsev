using Documents_Lekontsev.Interfaces;
...
namespace Documents_Lekontsev.Classes
{
    public class DocumentContext : Document, IDocument
    {

        public OleDbDataReader GetDataDocuments()
        {
        ...
        public List<DocumentContext> AllDocuments(OleDbDataReader oleDbDataReader)
        {
